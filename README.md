...
## Descripción
Sistema que permite gestionar repartos, usuarios, artículos y visualizar una simulación del comportamiento de repartidores en tiempo real.

## Uso
Iniciar el Sistema: python main.py
Para ejecutar la simulación de repartos: python simulation.py

## Endpoints API
/login: Iniciar sesión
/signup: Crear cuenta
/articulos: Gestionar artículos
/paquetes: Gestionar pedidos
